...
.PHONY: exec
exec:	build
	@echo Bargain logic puzzle ...
	@cabal exec bargain
	@echo Counter ...
	@cabal exec counter 4
	@echo Expensive Homes logic puzzle ...
	@cabal exec expensivehomes
	@echo FPComplete ...
	@cabal exec fpcomplete
	@echo Grandparents ...
	@cabal exec grandparents
	@echo Hockey Time logic puzzle ...
	@cabal exec hockeytime
	@echo Knights logic puzzle ...
	@cabal exec knights
	@echo Magicians logic puzzle ...
